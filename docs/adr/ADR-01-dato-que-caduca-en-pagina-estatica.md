...
- **JavaScript en la página.** Se acota a la isla del módulo: ~5 KB propios que solo pintan la
  sección meteo. La tabla de mareas, la curva, el coeficiente y las efemérides siguen siendo HTML
