...
constituyentes de NOAA más los 5 que T-04 le añadió (EP2, MA2, MB2, MKS2, 2MS6) y lanza
`UnsupportedConstituentError` ante cualquier otro: falla ruidoso a propósito. TICON-4 publica hasta
50, así que el dataset **se trunca a este conjunto antes de emitirse** y lo descartado se registra
en el propio JSON, para que el error de truncado sea medible y no un silencio.
...
#: Los 42 constituyentes que soporta el motor de producción —los 37 del juego estándar de NOAA más
#: los 5 de T-04—, con los nombres exactos que exporta `SUPPORTED_CONSTITUENTS` en
...
ENGINE_CONSTITUENTS: frozenset[str] = frozenset(
    {
        ...
        "SA", "SSA", "MM", "MF", "MSF",
        # Aguas someras
        "M3", "M4", "M6", "M8", "S4", "S6", "MN4", "MS4", "MK3", "2MK3", "2MS6",
    }
)
